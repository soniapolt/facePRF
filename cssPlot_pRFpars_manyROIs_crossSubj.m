...
niceBoxplot(allPars',allFactors,0,colors,cutY);
...
superTitle(titleText,titleSize,.025);
    ...
    if saveFig == 1
        txt = ['acrossROIs_' plotPar '_' hemText(hems)];
        niceSave([dirOf(pwd) 'figures/' expt '/randomEffects/'],txt,[],[],{'svg' 'png'}); % just save pngs, since these can be generated pretty quickly
    end
